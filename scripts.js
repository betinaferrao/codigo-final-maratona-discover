...
// objeto aqui no js e colocar no HTML
...
const DOM = {
    ...
    innerHTMLTransaction(transaction, index) {
        ...
        const html = `
            ...
            <td>
                <img onclick="Transaction.remove(${index}) " src="./assets/assets/minus.svg" alt="Remover Transição">
            </td>
        `
        return html
    },
...
const Utils = {
    ...
    formatCurrency(value){
        ...
        value = String(value).replace(/\D/g, "") //   /\D/ = muda tudo q n é numero para o segundo valor
...
const Form = {
    ...
    submit(event) {
        event.preventDefault() //Não add a url padrão
